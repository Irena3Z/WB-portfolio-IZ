    ...
    <div class="main-container">
        <!-- Main content sections -->
            ...
            <div class="about-me-section">
                ...
                <h1 class="about-me-name">Irena Zbitkovska</h1>
            ...
            <div class="my-work-experience-section">
                ...
                <div class="my-work-experience-company-block">
                    ...
                    <ul class="my-work-experience-duties">
                        <li class="my-work-experience-duty">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna.</li>
            ...
            <div class="my-education-section">
                ...
                <div>
                    <h4> <span class="my-education-university">National University of Radioelectronics</span></h4>
                    <h4 class="my-education-faculty">Management</h4>
                    <p class="my-education-period">September 2009 - June 2014 <span class="my-education-divider">|</span> Country</p>
                </div>
            </div>
        </div>
        ...
        <aside class="sidebar-section">
            <img src="img/mans.JPEG" alt="my photo">

            <!-- Contact section -->
            <div class="contact-section">
                <h3 class="sidebar-title">Contacts</h3>
                <div>
                    <spam class="contact-section-type">C:</spam>
                    <a class="contact-section-link" href="tel:+77777777777">+7 777 777 77 77</a>   
                </div>
                <div>
                    <spam class="contact-section-type">E:</spam>
                    <a class="contact-section-link" href="mailto:i.zbit@gmail.com">i.zbit@gmail.com</a>
                </div>
            </div>
            ...
            <div class="tech-skills-section">
                ...
                <ul class="tech-skills-list">
                    <li class="tech-skills-item"> <spam class="tech-skills-item-text">HTML5</spam> </li>
                    <li class="tech-skills-item"> <spam class="tech-skills-item-text">CSS3</spam></li>
                    <li class="tech-skills-item"> <spam class="tech-skills-item-text">GIT</spam></li>
                    <li class="tech-skills-item"> <spam class="tech-skills-item-text">WebPack</spam></li>
                    <li class="tech-skills-item"> <spam class="tech-skills-item-text">JavaScript</spam></li>
                    <li class="tech-skills-item"> <spam class="tech-skills-item-text">React.js</spam></li>
                    <li class="tech-skills-item"> <spam class="tech-skills-item-text">Node.js</spam></li>
                </ul>
            </div>
            ...
            <div class="soft-skills-section">
                ...
                <ul class="soft-skills-list">
                    <li class="soft-skills-item"><spam class="soft-skills-item-text">Scrum</spam></li>
                    <li class="soft-skills-item"><spam class="soft-skills-item-text">Agile</spam></li>
                    <li class="soft-skills-item"><spam class="soft-skills-item-text">GTD</spam></li>
                    <li class="soft-skills-item"><spam class="soft-skills-item-text">Teamwork</spam></li>
                </ul>
            </div>
        </aside>
